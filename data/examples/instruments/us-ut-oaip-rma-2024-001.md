...
instance: 2024-001
slug: utah-elizachat-teen-mental-health-2024
name: "ElizaChat Regulatory Mitigation Agreement — Teen Mental-Health AI App"
title: "Utah OAIP × ElizaChat — Teen Mental-Health App RMA (2024)"
type: rma
...
source_documents:
  - Signed-Elizachat-Agreement-November-2024.pdf
extracted_text: Signed-Elizachat-Agreement-November-2024.txt
obligation_kind: [permission, requirement, restriction]
reliance_scope: requesting-party-only
participating_party: "ElizaChat, Inc."
...
statute_anchors:
  ...
  - cite: "Utah Code §13-2-12(4) (GenAI disclosure — pre-§13-77)"
    url: "https://le.utah.gov/xcode/Title13/Chapter2/13-2-S12.html"
  - cite: "Utah Code §58-1-501"
    url: "https://le.utah.gov/xcode/Title58/Chapter1/58-1-S501.html"
  - cite: "Utah Code §58-60-102(17) (Mental-health therapy definition)"
    url: "https://le.utah.gov/xcode/Title58/Chapter60/58-60-S102.html"
  - cite: "Utah Code §58-61-102(8) (Psychology Practice Act — therapy definition)"
    url: "https://le.utah.gov/xcode/Title58/Chapter61/58-61-S102.html"
...
Executed 2024-11-14 (OAIP Director Zachary Boyd), 2024-11-15 (ElizaChat CEO Dave Barney), and 2024-11-18 (DOPL Director Mark Steinagal). Effective date is the latter signature date. The Agreement predates Utah's §13-77 Generative AI chapter; user-facing GenAI disclosure is anchored to Utah Code §13-2-12(4), the earlier statutory basis. The Agreement is among the earliest OAIP RMAs and established the phased-rollout template later echoed in other Learning Lab instruments.
...
- GenAI disclosure (§13-2-12(4)) with user acknowledgment.
- Monthly reporting to ai@utah.gov: findings, complaints, impact analyses, technology assessments.

## Reliance scope

Requesting-party-only. Mitigation runs to ElizaChat, Inc. It expressly does not bar any claim by an individual user, parent, guardian, or any Utah political subdivision other than DOPL (Schedule A §XV.F).
...
- Pre-§13-77 instrument: references §13-2-12(4) for GenAI disclosure where later Utah RMAs reference §13-77-103.
