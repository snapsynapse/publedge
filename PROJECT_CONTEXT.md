...
Public and maintained. Spec at `v0.2.0`; package `v0.2.5` is published to npm
and the Official MCP Registry. Current npm, MCP Registry, Git tag, and GitHub
Release observations are recorded in `design/publication-state.json`. PubLedge is the
