...
const gates = [
    ...
    [npm, ['run', 'test:source-mapping']],
    [npm, ['run', 'test:publication-state']],
    [npm, ['run', 'build']],
    [npm, ['run', 'test:of-evidence-inputs']],
    [npm, ['run', 'test:doctronic-observation']],
    [npm, ['run', 'test:colorado-order24']],
