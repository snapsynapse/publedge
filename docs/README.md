...
[![Spec](https://img.shields.io/badge/spec-v0.1.2-blue)](PROTOCOL.md)
...
**Public and maintained. Protocol specification v0.1.2; stable MCP server v0.1.2. Standalone product expansion is parked pending a concrete legal-graph or adopter demand signal.**
